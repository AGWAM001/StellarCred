...
| `income_proof`         | 588                | 1 blackbox¹    | 4              | ~577                      | ~7 (≥ comparison) | +6 opcodes vs kyc for `income ≥ threshold`. |
| `funds_proof`          | 588                | 1 blackbox¹    | 4              | ~577                      | ~7 (≥ comparison) | Identical profile to income_proof. |
| `accreditation_proof`  | 588                | 1 blackbox¹    | 4              | ~577                      | ~7 (≥ comparison) | Identical profile to income_proof. |
...
| `income_proof` | +6 | `income ≥ threshold` (u64) | ~7 |
| `funds_proof` | +6 | `balance ≥ threshold` (u64) | ~7 |
| `accreditation_proof` | +6 | `net_worth ≥ threshold` (u64) | ~7 |
...
~10–15 opcodes (the division and quotient directives). Backend gate savings are
an estimated ~2,000 (not yet profiled with `bb`).
...
- [Noir 1.0.0-beta.9 release notes](https://github.com/noir-lang/noir/releases/tag/v1.0.0-beta.9)
- [Barretenberg v0.87.0](https://github.com/AztecProtocol/aztec-packages/releases/tag/barretenberg-v0.87.0)
- [Poseidon2 for Noir](https://github.com/noir-lang/poseidon) (tag v0.2.0)
- [Issue #9 — age_proof specific optimization discussion](https://github.com/ToluLabs/StellarCred/issues/9)
- [Issue #83 — This audit](https://github.com/ToluLabs/StellarCred/issues/83)
