      ...
      <div className="card" style={{ padding: "1.75rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
          ...
          <ProofStep
            ...
            state={
              (stage === "witness" || stage === "proving") ? "active" :
              proofDone ? "done" : "idle"
            }
            detail={
              (stage === "witness" || stage === "proving") ? (
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", marginTop: "0.65rem" }}>
                  ...
                  <span className="mobile-only-note" style={{ fontSize: "0.72rem", color: "var(--accent)", marginTop: "0.2rem" }}>
                    Keep this tab open while proving
                  </span>
                </div>
              ) : proofDone && proof ? (
