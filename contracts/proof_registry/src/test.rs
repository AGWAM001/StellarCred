...
// TODO: accreditation_threshold_stored_and_checked test will be added once
// fixtures/accreditation/ artifacts are generated by circuits/scripts/build.sh.
// Requires Noir 1.0.0-beta.9 + bb 0.87.0 to compile the accreditation_proof circuit.
